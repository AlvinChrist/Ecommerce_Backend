    ...
    try {
        ...
        for (const item in cart) {
            await Product.findOne({
                ...
                if(cart[item].product.discountId){
                    cart[item].product.setDataValue('product_discount', detail.product_discount)
                    cart[item].setDataValue("beforeDiscount", cart[item].product.productPrice)
                    cart[item].product.productPrice = (100 - detail.product_discount.discountPercent) / 100 * cart[item].product.productPrice    
                }
            
                cart[item].product.setDataValue('imagePath', detail.product_galleries[0].dataValues.imagePath)
        ...
        //             item.product.setDataValue('imagePath', detail.product_galleries[0].dataValues.imagePath)
        //          }).then(()=>{
